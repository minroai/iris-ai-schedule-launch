  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 backdrop-blur-lg relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        iridescent: "bg-gradient-to-br from-white/20 via-pink-50/15 to-white/12 text-foreground font-semibold border border-white/40 shadow-[inset_0_3px_6px_0_rgba(255,255,255,0.5),inset_0_-3px_6px_0_rgba(236,72,153,0.15),0_20px_60px_rgba(139,92,246,0.25),0_8px_32px_rgba(236,72,153,0.2)] hover:bg-gradient-to-br hover:from-white/25 hover:via-cyan-50/20 hover:to-white/15 hover:border-white/50 hover:shadow-[inset_0_4px_8px_0_rgba(255,255,255,0.6),inset_0_-4px_8px_0_rgba(14,165,233,0.2),0_30px_80px_rgba(236,72,153,0.35),0_12px_48px_rgba(14,165,233,0.3)] transform hover:-translate-y-2 hover:scale-[1.03] before:absolute before:inset-0 before:bg-gradient-to-br before:from-pink-200/30 before:via-purple-200/12 before:to-cyan-200/20 before:rounded-2xl after:absolute after:inset-[1px] after:bg-gradient-to-br after:from-white/25 after:via-pink-100/8 after:to-cyan-100/15 after:rounded-[15px] after:pointer-events-none",
      },
      size: {
