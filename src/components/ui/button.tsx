  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 backdrop-blur-lg relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        iridescent: "bg-gradient-to-br from-pink-200/25 via-purple-200/20 to-cyan-200/25 text-foreground font-semibold border border-white/40 shadow-[inset_0_3px_6px_0_rgba(255,255,255,0.5),0_20px_60px_rgba(139,92,246,0.25)] hover:bg-gradient-to-br hover:from-cyan-200/30 hover:via-yellow-200/25 hover:to-pink-200/30 hover:border-white/50 hover:shadow-[inset_0_4px_8px_0_rgba(255,255,255,0.6),0_30px_80px_rgba(236,72,153,0.35)] transform hover:-translate-y-2 hover:scale-[1.03] before:absolute before:inset-0 before:bg-gradient-to-br before:from-pink-300/20 before:via-purple-300/15 before:to-cyan-300/20 before:rounded-2xl before:animate-pulse after:absolute after:inset-[1px] after:bg-gradient-to-br after:from-white/25 after:via-rainbow after:to-white/25 after:rounded-[15px] after:pointer-events-none [background-image:linear-gradient(45deg,rgba(236,72,153,0.3),rgba(139,92,246,0.3),rgba(14,165,233,0.3),rgba(16,185,129,0.3),rgba(245,158,11,0.3))] [background-size:300%_300%] animate-[gradient_3s_ease_infinite] [@keyframes_gradient]:0%{background-position:0%_50%} [@keyframes_gradient]:50%{background-position:100%_50%} [@keyframes_gradient]:100%{background-position:0%_50%}",
      },
      size: {
