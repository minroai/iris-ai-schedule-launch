  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 backdrop-blur-lg relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        iridescent: "group relative bg-gradient-to-br from-primary/90 via-accent/80 to-primary/90 text-primary-foreground font-medium border border-white/25 shadow-[0_8px_32px_rgba(139,92,246,0.25),inset_0_1px_2px_rgba(255,255,255,0.3)] hover:shadow-[0_12px_48px_rgba(139,92,246,0.4),inset_0_2px_4px_rgba(255,255,255,0.4)] transform hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/15 before:via-transparent before:to-white/10 before:rounded-2xl after:absolute after:inset-[1px] after:bg-gradient-to-b after:from-white/20 after:via-transparent after:to-transparent after:rounded-[15px] after:pointer-events-none overflow-hidden [background-size:200%_200%] animate-[shimmer_3s_ease-in-out_infinite] [@keyframes_shimmer]:0%{background-position:200%_200%} [@keyframes_shimmer]:50%{background-position:0%_0%} [@keyframes_shimmer]:100%{background-position:200%_200%}",
      },
      size: {
